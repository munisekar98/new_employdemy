    ...
    stages {
        ...
        stage('Deploy to AEM') {
            steps {
                ...
                sh 'curl -u admin:admin -X POST -F package=@".json/etc/packages/com.employdemy/employdemy.ui.apps-1.0.0-SNAPSHOT.zip" http://13.49.72.14:4502/crx/packmgr/service.jsp'
                sh 'curl -u admin:admin -X POST -F package=@".json/etc/packages/com.employdemy/employdemy.ui.config-1.0.0-SNAPSHOT.zip" http://13.49.72.14:4502/crx/packmgr/service.jsp'
                sh 'curl -u admin:admin -X POST -F package=@".json/etc/packages/com.employdemy/employdemy.ui.content-1.0.0-SNAPSHOT.zip" http://13.49.72.14:4502/crx/packmgr/service.jsp'
